 ...
 * Generated for Laravel 5.1.45 (LTS) on 2016-12-27.
 *
...
namespace {
    ...
    class App extends \Illuminate\Support\Facades\App{
        ...
        /**
         * Get the version number1 of the application.
         *
         * @return string
         * @static
         */
    ...
    class JWTAuth extends \Tymon\JWTAuth\Facades\JWTAuth{
        ...
        public static function refresh(){
            //Method inherited from \Tymon\JWTAuth\JWT
            return \Tymon\JWTAuth\JWTAuth::refresh();
        }
         ...
         * @static
         */
        public static function makePayload($user){
            //Method inherited from \Tymon\JWTAuth\JWT
            return \Tymon\JWTAuth\JWTAuth::makePayload($user);
        }
    ...
    class JWTFactory extends \Tymon\JWTAuth\Facades\JWTFactory{
        ...
        public static function make(){
            return \Tymon\JWTAuth\Factory::make();
        }
        ...
        public static function iss(){
            return \Tymon\JWTAuth\Factory::iss();
        }
        ...
        public static function iat(){
            return \Tymon\JWTAuth\Factory::iat();
        }
        ...
        public static function exp(){
            return \Tymon\JWTAuth\Factory::exp();
        }
        ...
        public static function nbf(){
            return \Tymon\JWTAuth\Factory::nbf();
        }
         ...
         */
        public static function setRequest($request){
            return \Tymon\JWTAuth\Factory::setRequest($request);
        }
    ...
    class Prodeb extends \App\Facades\Prodeb{

        /**
         * Transforma uma data string em um objeto Carbon
         *
         * @param $date data no formato de string
         * @return \App\Util\Objeto do Carbon com a data transformada
         * @static
         */
        public static function parseDate($date){
            return \App\Util\Prodeb::parseDate($date);
        }
        ...
        public static function modelNames($ignoredModels = array()){
            return \App\Util\Prodeb::modelNames($ignoredModels);
        }
